                        ...
                        <form method="post" action="/siswa/store" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nama" id="input-nama" class="form-control form-control-alternative{{ $errors->has('nama') ? ' is-invalid' : '' }}" placeholder="Nama" required autofocus>
                                    @if ($errors->has('nama'))
                                ...
                                <div class="form-group{{ $errors->has('alamat') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="contact" id="input-alamat" class="form-control form-control-alternative{{ $errors->has('alamat') ? ' is-invalid' : '' }}" placeholder="{{ __('alamat') }}" required>
